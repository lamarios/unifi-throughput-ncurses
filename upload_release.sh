...
curl --location --request POST "https://uploads.github.com/repos/lamarios/unifi-throughput-ncurses/releases/${RELEASE}/assets?access_token=${GITHUB_TOKEN}&name=${FILE}" --data-binary "@${FILE_PATH}" -H "Content-type: application/tar+gzip"
